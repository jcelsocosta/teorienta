...
cucumber_1.defineSupportCode(function (_a) {
    ...
    Given(/^I am at the home page$/, function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.browser.get("http://localhost:4200/")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, protractor_1.$("a[name='login']").click()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    When(/^I try fill username with "([^\"]*)" and  password with "([^\"]*)"$/, function (username, password) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.$("input[name='username']").sendKeys(username)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, protractor_1.$("input[name='password'").sendKeys(password)];
                case 2:
                    _a.sent();
    ...
    Given(/^I can see menu with announcements$/, function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    timeout();
                    return [4 /*yield*/, protractor_1.$("a[name='navbarAnnouncement']").click()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    When(/^I try insert announcements$/, function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
